...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Bad Bunny-Un Verano Sin Ti</h1>
                <p>
                    Un Verano Sin Ti (Spanish pronunciation: [un veˈɾano sin ˈti]; translation. A Summer Without You) 
                    <br>
                    is the fourth solo studio album, and fifth overall, by Puerto Rican rapper and singer Bad Bunny.
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/1.jpg" alt="Bad Bunny" id="poster_master_play">
            <h5 id="title">Moscow Mule <br>
                <div class="subtitle">Bad Bunny</div>
            </h5>
            <div class="icon">
