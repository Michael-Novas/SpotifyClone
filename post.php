...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/post/background.jpg');
            opacity: 50%;
        }
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Post Malone - Austin</h1>
                <p>
                Austin is the fifth studio album by American rapper and singer Post Malone. 
                <br>
                It was released through Republic and Mercury Records on July 28, 2023.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/post/1.jpg" alt="Post Malone" id="poster_master_play">
            <h5 id="title">Don't Understand <br>
                <div class="subtitle">Post Malone</div>
            </h5>
            <div class="icon">
