...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/tiller/background.jpg');
            opacity: 50%;
        }
    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="img/tiller/1.jpg" alt="Bryson Tiller">
                    <h5>
                        Be Mine This Christmas
                        <div class="subtitle">Bryson Tiller</div>
                    </h5>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Bryson Tiller - A Different Christmas</h1>
                <p>
                A Different Christmas serves as Bryson Tiller’s debut extended play. 
                <br>
                It serves as the bridge from his third studio album, A N N I V E R S A R Y, 
                <br>
                from October 2020, and its deluxe version from February 2021, to his upcoming fourth studio album, 
                <br>
                Serenity, which is expected to be released sometime in 2022.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    ...
                    <li class="songItem">
                        <div class="img_play">
                            <img src="img/tiller/2.jpg" alt="Bryson Tiller">
                    ...
                    <!-- <li class="songItem">
                        <div class="img_play">
                            <img src="img/taylor/1.jpg" alt="Taylor Swift">
        ...
        <div class="master_play">
            ...
            <img src="img/tiller/1.jpg" alt="Bryson Tiller" id="poster_master_play">
            <h5 id="title">Be Mine This Christmas <br>
                <div class="subtitle">Bryson Tiller</div>
            </h5>
            <div class="icon">
