...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/wayne/background.jpg');
            opacity: 50%;
        }
    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="img/wayne/1.jpg" alt="Lil Wayne">
                    <h5>
                        Intro
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Lil Wayne - Tha Carter IV</h1>
                <p>
                Tha Carter IV is the ninth studio album by American rapper Lil Wayne, released on August 29, 2011. 
                <br>
                Tha Carter IV had 300,000 downloads in its first four days online, which broke an iTunes record.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/wayne/1.jpg" alt="Lil Wayne" id="poster_master_play">
            <h5 id="title">Intro <br>
                <div class="subtitle">Lil Wayne</div>
            </h5>
            <div class="icon">
