...
const songs = [
    ...
    {
        id: '4',
        songName:` Snow On The Beach <br>
        <div class="subtitle">Taylor Swift</div>`,
        poster: "img/taylor/1.jpg"
    },
    {
        id: '5',
        songName:` You're On Your Own, Kid <br>
        <div class="subtitle">Taylor Swift</div>`,
        poster: "img/taylor/1.jpg"
    },
    {
        id: '6',
        songName:` Midnight Rain <br>
        <div class="subtitle">Taylor Swift</div>`,
        poster: "img/taylor/1.jpg"
    },
    {
        id: '7',
        songName:` Question...? <br>
        <div class="subtitle">Taylor Swift</div>`,
        poster: "img/taylor/1.jpg"
    },
    {
        id: '8',
        songName:` Vigilante Shit <br>
        <div class="subtitle">Taylor Swift</div>`,
        poster: "img/taylor/1.jpg"
    },
    {
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click', (e)=>{
        ...
        download_music.href = `audio/taylor/${index}.mp3`;
        poster_master_play.src = `img/taylor/${index}.jpg`;
        music.play();
