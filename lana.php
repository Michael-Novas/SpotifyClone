...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/lana/background.jpg');
            opacity: 50%;
        }
    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="img/lana/1.jpg" alt="Lana Del Rey">
                    <h5>
                        Born To Die
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Lana Del Rey - Born To Die</h1>
                <p>
                Born to Die is the debut major label studio album and second studio album by American singer-songwriter Lana Del Rey. 
                <br>
                It was released on January 27, 2012, through Interscope Records and Polydor Records.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
            ...
            <div class="popular_song">
                ...
                <div class="pop_song">
                    ...
                    <li class="songItem">
                        ...
                        <h5>This Is What Makes Us Girls
                            <br>
                            <div class="subtitle">Lana Del Rey</div>
                        </h5>
                    </li>
                    <!-- <li class="songItem">
                        <div class="img_play">
                            <img src="img/post/1.jpg" alt="Post Malone">
        ...
        <div class="master_play">
            ...
            <img src="img/lana/1.jpg" alt="Lana Del Rey" id="poster_master_play">
            <h5 id="title">Born To Die <br>
                <div class="subtitle">Lana Del Rey</div>
            </h5>
            <div class="icon">
