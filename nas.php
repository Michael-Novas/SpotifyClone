...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/nas/background.jpg');
            opacity: 50%;
        }
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Nas - King's Disease II</h1>
                <p>
                King's Disease II is the 13th studio album by American rapper Nas. 
                <br>
                It was released on August 6, 2021, through Mass Appeal Records and marketed by The Orchard. 
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/nas/1.jpg" alt="Nas" id="poster_master_play">
            <h5 id="title">The Pressure <br>
                <div class="subtitle">Nas</div>
            </h5>
            <div class="icon">
