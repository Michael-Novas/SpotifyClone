...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/drake/background.jpg');
            opacity: 50%;
        }
...
<body>
    <header>
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Drake - Scorpion</h1>
                <p>
                Scorpion is the fifth studio album by Canadian rapper and singer Drake.
                <br> 
                It was released on June 29, 2018, by Cash Money Records, Republic Records, and Young Money Entertainment. 
                <br>
        ...
        <div class="master_play">
            ...
            <img src="img/drake/1.jpg" alt="Drake" id="poster_master_play">
            <h5 id="title">Peak <br>
                <div class="subtitle">Drake</div>
            </h5>
            <div class="icon">
