...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/taylor/background.jpg');
            opacity: 50%;
        }
    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                ...
                <li class="songItem">
                    <span>02</span>
                    <img src="img/taylor/1.jpg" alt="Taylor">
                    <h5>
                        Maroon
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Taylor Swift - Midnights</h1>
                <p>
                Midnights is the tenth studio album by American songstress Taylor Swift. 
                <br>
                She first revealed the project during her acceptance speech for Video of the Year at the 2022 VMAs, 
                <br>
                unveiling the album’s release date and saying she’d give fans more information at midnight that night.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/taylor/1.jpg" alt="Taylor Swift" id="poster_master_play">
            <h5 id="title">Lavender Haze <br>
                <div class="subtitle">Taylor Swift</div>
            </h5>
            <div class="icon">
