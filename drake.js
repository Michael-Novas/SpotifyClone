const music = new Audio('audio/drake/1.mp3');
...
const songs = [
    ...
    {
        id: '7',
        songName:` Emotionless <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    },
    {
        id: '8',
        songName:` Nice For What <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    },
    {
    ...
    {
        id: '11',
        songName:` I'm Upset <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    },
    {
        id: '12',
        songName:` Ratchet Happy Birthday <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    },
    {
        id: '13',
        songName:` 8 out of 10 <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    },
    {
        id: '14',
        songName:` That's How You Feel <br>
        <div class="subtitle">Drake</div>`,
        poster: "img/drake/1.jpg"
    }
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element)=>{
    element.addEventListener('click', (e)=>{
        ...
        music.src = `audio/drake/${index}.mp3`;
        download_music.href = `audio/drake/${index}.mp3`;
        poster_master_play.src = `img/drake/${index}.jpg`;
        music.play();
