...
<head>
    ...
    <style>
        header .song_side::before {
            background: url('img/russ/background.jpg');
            opacity: 50%;
        }
    ...
    <header>
        <div class="menu_side">
            ...
            <div class="menu_song">
                <li class="songItem">
                    <span>01</span>
                    <img src="img/russ/1.jpg" alt="Russ">
                    <h5>
                        Sheep
        ...
        <div class="song_side">
            ...
            <div class="content">
                <h1>Russ - Chomp 2</h1>
                <p>
                CHOMP 2 is the sequel to his previous EP CHOMP which dropped November, 2020. 
                <br>
                CHOMP 2 continues the theme of heavy spitting rap as Russ recruits some of the biggest names in the rap game.  
                </p>
                <div class="buttons">
                    <button>PLAY</button>
        ...
        <div class="master_play">
            ...
            <img src="img/russ/1.jpg" alt="Russ" id="poster_master_play">
            <h5 id="title">Sheep <br>
                <div class="subtitle">Russ</div>
            </h5>
            <div class="icon">
